...
#define LOG_MSG(...) std::cout << std::format(__VA_ARGS__) << std::endl;
#define LOG_ERROR(...) error_logger << "Error: " << std::format(__VA_ARGS__) << std::endl;
#define LOG_WARNING(...) warning_logger << "Warning: " << std::format(__VA_ARGS__) << std::endl;